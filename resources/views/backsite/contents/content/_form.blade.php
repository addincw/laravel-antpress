            ...
            <div class="card-body">
              ...
              <div class="btn-group" style="width:100%">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" style="width: 100%; position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(103px, 41px, 0px);">
                    <a class="dropdown-item" target="_blank" href="{{ url('backsite/konten/galeri/create?content_id=' . $content->id) }}"><i class="ft-copy"></i> Banyak Galeri </a>
                    <a class="dropdown-item" target="_blank" href="{{ url('backsite/konten/galeri/single?content_id=' . $content->id) }}"><i class="ft-square"></i> Single Galeri </a>
                    <a class="dropdown-item" target="_blank" href="{{ url('backsite/konten/galeri/video?content_id=' . $content->id) }}"><i class="ft-video"></i> Video </a>
                </div>
              </div>
            </div>
          </div>
