...
<div class="card">
  <div class="card-header">
    <h4 class="card-title">
      FAQ
      <a class="btn btn-primary white pull-right" href="{{ url($route . '/create') }}">Tambah FAQ <i class="ft-plus"></i> </a>
    </h4>
  </div>
  <div class="card-body">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-truncate text-center">
              <a href='{{ url("$route/$faq->id/edit") }}' class="btn btn-sm btn-icon btn-pure info"><i class="ft-edit"></i></a>
              <a href="{{ url($route . '/' . $faq->id) }}" class="btn btn-sm btn-icon btn-pure danger deleteBtn"><i class="ft-trash"></i></a>
            </td>
          </tr>
          @endforeach
        </tbody>
